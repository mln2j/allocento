  ...
  template: `
    <div class="fixed inset-0 flex flex-col items-center justify-center bg-brand-mint p-6 text-center">
      <div class="max-w-md p-10 bg-white rounded-3xl shadow-2xl border border-slate-100 flex flex-col items-center">
        ...
        <h1 class="text-3xl font-bold text-[#621E95] mb-4 tracking-tighter" style="font-family: 'Space Mono', 'Courier New', monospace;">
        ...
        <button
          (click)="retry()"
          class="w-full py-4 px-6 bg-[#621E95] hover:bg-[#621E95]/90 text-white rounded-2xl font-semibold shadow-lg shadow-[#621E95]/30 transition-all duration-200"
